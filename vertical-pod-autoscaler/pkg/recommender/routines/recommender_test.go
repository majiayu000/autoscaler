...
func TestProcessUpdateVPAsConcurrency(t *testing.T) {
	...
	fakeClient := vpa_fake.NewSimpleClientset(fakedClient...).AutoscalingV1() //nolint:staticcheck // NewClientset requires OpenAPI schema, tracked in https://github.com/kubernetes/kubernetes/pull/131068
	r := &recommender{
